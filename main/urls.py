...
urlpatterns = [
    ...
    path('ad/youtube-videos/', views.manage_youtube_videos, name='manage_youtube_videos'),
    path('ad/youtube-videos/approve/<int:video_id>/', views.approve_youtube_video, name='approve_youtube_video'),
    path('ad/youtube-videos/reject/<int:video_id>/', views.reject_youtube_video, name='reject_youtube_video'),
...
path('students/filter_by_level/', filter_students_by_level, name='filter_students_by_level'),
path('students/filter_by_class/', filter_students_by_class, name='filter_students_by_class'),
